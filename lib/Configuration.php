...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://secure.usaepay.com/api/v2';
    ...
    /**
     * Creates authorization hash
     *
     * @param string $apiKey API Key generated in merchant console
     *
     * @param string $pin API Key pin set in merchant console
     *
     * @return $this
     */    
    public function setAuthorization($apiKey,$pin="")
    {
    ...
    {
        $report  = 'PHP SDK (USAePay) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return array(
          array(
            "url" => "https://{SubDomain}.usaepay.com/api/{EndpointKey}",
            "description" => "No description provided",
            "variables" => array(
              "SubDomain" => array(
                  "description" => "Subdomain can be used for high availablity or to use our sandbox environment",
                  "default_value" => "secure",
                ),
              "EndpointKey" => array(
                  "description" => "Endpoint Keys can be generated in our developer portal",
                  "default_value" => "v2",
                )
              )
          )
